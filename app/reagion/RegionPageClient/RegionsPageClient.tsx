    ...
    <div>
      ...
      <div className="flex  flex-row flex-wrap justify-center gap-4 p-1">
        {places?.data.map((place, index) => (
          <div
            key={index}
            className="flex content-between bg-amber-800  w-full sm:w-[48%] lg:w-[31%] xl:w-[23%] rounded-xl glass transition-all duration-300 ">
            <FlipCard
            className=""
              key={place.id}
              front={(flip) => (
                <div className="">
                  <figure className="w-full h-48 md:h-56 lg:h-64 overflow-hidden rounded-t-xl flex-1">
                    <Image
                      width={400}
                      height={200}
                  ...
                  <div className="p-4 md:p-5 flex flex-col ">
                    ...
                    <div className="flex flex-col flex-2 sm:flex-row items-center justify-between gap-3 ">
