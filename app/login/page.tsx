    ...
    <div className=' animate-enter '>
      ...
      >
        ...
        <p className='pt-4 text-sm text-[#832411] text-center'>
          ليس لديك حساب؟{" "}
        <Link className='  hover:border-b-[#832411] border-b-2 duration-250 transition-all font-bold border-[#83241100]' href={'/register'}>إنشاء حساب </Link>
